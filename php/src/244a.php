                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    <input id="nom<?= $i ?>" name="nom<?= $i ?>" placeholder="Nombre del producto" type="text" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    <input id="preu<?= $i ?>" name="preu<?= $i ?>" placeholder="Precio del producto" type="text" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                <?php } ?>
